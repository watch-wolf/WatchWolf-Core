package dev.watchwolf.core.entities.blocks.transformer;

import dev.watchwolf.core.entities.blocks.Block;
import dev.watchwolf.core.entities.blocks.BlockModifier;
...
/**
 * This is the base class to automatically generate all the `dev.watchwolf.core.entities.blocks.special`
 * classes.
